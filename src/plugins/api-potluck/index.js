...
const apiPotluckPlugin = {
    name: 'api-potluck',
    version: '1.0.2',
    description: 'A计划 - Key 管理和用量统计插件<br>管理端：<a href="potluck.html" target="_blank">potluck.html</a><br>用户端：<a href="potluck-user.html" target="_blank">potluck-user.html</a>',
